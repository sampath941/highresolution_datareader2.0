...
def upload():
    if request.method == 'POST':
        ...
        if file and file.filename != '':
            ...
            result = filename.endswith('.db')
            print(result)
            if result == False:
                return redirect(url_for('main.index')), session.clear(), flash('Plase upload a .db file generated by controller. Please refresh the page and try', 'error')
            else:
